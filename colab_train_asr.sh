...
#Dataset 3 Label
#Train
cp "$GOOGLE_DRIVE_PATH/$DATASET3/$DATASET3_SUBDIR/1.$TRAINING/$DATASET3_LABEL/TL01_뇌신경장애.zip" &

#Validation
cp "$GOOGLE_DRIVE_PATH/$DATASET3/$DATASET3_SUBDIR/2.$VALIDATION/$DATASET3_LABEL/VL01_뇌신경장애.zip" &

#Dataset 3 Source
#Train
cp "$GOOGLE_DRIVE_PATH/$DATASET3/$DATASET3_SUBDIR/1.$TRAINING/$DATASET3_SRC/TS01_뇌신경장애.zip" &

#Validation
cp "$GOOGLE_DRIVE_PATH/$DATASET3/$DATASET3_SUBDIR/2.$VALIDATION/$DATASET3_SRC/VS01_뇌신경장애.zip" &
